...
class GetEventsDataFromLocal extends GetData<EventsDataList, int> {
  final DataRepository _repository;

  GetEventsDataFromLocal(DataRepository repository) : _repository = repository;

  @override
  Future<Either<Failure, EventsDataList>> call([int? params]) async {
    return await _repository.getEventsDataFromLocal(params);
  }
}
